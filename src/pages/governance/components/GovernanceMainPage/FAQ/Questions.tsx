...
const Questions = () => (
    <Container>
        <Question
            ...
            answer={
                <span>
                    ...
                    protocol. AQUA holders can create proposals and start community discussions
                    before deciding whether to publish proposals for a vote.
                </span>
            }
        />
        <Question
            ...
            answer={
                <span>
                    ...
                    content. Ensure you give as much detail as possible, especially the
                    implementation plan.
                </span>
            }
        />
        <Question
            ...
            answer={
                <span>
                    Before a proposal can be published, discussions must take place. The mandatory 7
                    day discussion phase allows for gathering feedback and more in-depth talks
                    between proposal creators and the wider AQUA community.
                </span>
            }
        />
        <Question
            ...
            answer={
                <span>
                    ...
                    necessary if the initial proposal isn’t clear or any changes are put forward in
                    the discussion phase. Stronger proposals are more likely to pass.
                </span>
            }
        />
        <Question
            ...
            answer={
                <span>
                    ...
                    Creators will only see the <b>Publish</b> option once the minimum discussion
                    phase has passed.
                </span>
            }
        />
        ...
        <Question
            ...
            answer={
                <span>
                    A fee of <b>{formatBalance(CREATE_DISCUSSION_COST)} AQUA is needed to create</b>{' '}
                    a proposal discussion. To move a discussion to the publishing phase requires a
