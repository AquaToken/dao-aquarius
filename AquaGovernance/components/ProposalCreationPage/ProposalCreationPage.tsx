...
import CreateDiscussionModal from './CreateDiscussionModal/CreateDiscussionModal';
...
const ProposalCreationPage = ({ isEdit }: { isEdit?: boolean }): JSX.Element => {
    ...
    useEffect(() => {
        ...
        getProposalRequest(id)
            ...
            .catch(() => {
                ...
                history.push(`${MainRoutes.proposal}/${id}`);
            });
    }, [isEdit]);
